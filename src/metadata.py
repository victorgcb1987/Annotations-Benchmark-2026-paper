...
class Species:
    ...
    def get_taxonomic_data(self, species):
        ...
        if metadata.returncode == 0:
            ...
            self.species = tax_metadata["species"]["name"]
            self.genus = tax_metadata["genus"]["name"]
            self.familiy = tax_metadata["family"]["name"]
            self.tax_class = tax_metadata["class"]["name"]
